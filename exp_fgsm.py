...
It does not train or resume models. It expects run directories such as
    ...
    <trained_dir>/runs/pc_memory_K2__seed0/
    <trained_dir>/runs/astro_gain_only__seed0/
    <trained_dir>/runs/astro_gain_state_coupling__seed0/
    <trained_dir>/runs/astro_gain_state_coupling_leakage__seed0/
